...
<html>
  <head>
    ...
    <title>Welcome Azure DevOps Class</title>
  </head>
  ...
  <body>
    ...
    <div id="hate" class="container snakes snake-hater">
      <h1 class="cover-heading">Welcome To DevOps B24 Batch</h1>
      <p class="lead">We Are Learning Azure DevOps(ADO) - Pipelines</p>
      <iframe src="https://giphy.com/embed/eAqiY1laFuW88" width="480" height="207" frameBorder="0" class="giphy-embed" allowFullScreen></iframe><p><a href="https://giphy.com/gifs/iheartindianmovies-babu-mahesh-eAqiY1laFuW88">via GIPHY</a></p>
      <!--Intro -->
